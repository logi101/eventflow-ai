...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-4" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      <div className={`glass-modal w-full ${sizeClasses[size]} max-h-[90vh] overflow-y-auto rounded-2xl`}>
        ...
        <div className="p-6 border-b border-white/10 flex justify-between items-center sticky top-0 bg-[#0f1117]/95 backdrop-blur-xl rounded-t-2xl">
          ...
          {showClose && (
            <button onClick={onClose} className="p-2 hover:bg-[#1a1d27]/10 rounded-xl transition-colors" aria-label="סגור חלון">
