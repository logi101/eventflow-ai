...
CREATE INDEX IF NOT EXISTS idx_vendor_analysis_vendor_id ON vendor_analysis(vendor_id);
CREATE INDEX IF NOT EXISTS idx_vendor_analysis_organization_id ON vendor_analysis(organization_id);
CREATE INDEX IF NOT EXISTS idx_vendor_analysis_date ON vendor_analysis(analysis_date DESC);
...
DO $$
BEGIN
  RAISE NOTICE '✓ Migration 012 complete: Premium tables created + RLS policies applied';
