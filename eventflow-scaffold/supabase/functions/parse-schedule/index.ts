...
serve(async (req) => {
    ...
    6. CRITICAL: PRESERVE ORIGINAL LANGUAGE (Hebrew/English).
    7. AUTO-REPAIR ENCODING: If text looks like gibberish (e.g., "×©×œ×•×™" or "Ã—Ã©"), it is likely UTF-8 read as Latin-1. YOU MUST RESTORE THE ORIGINAL HEBREW.
       Example: "×©×œ×•×™" -> "שלו"
    8. Return ONLY a JSON array. No code blocks, no markdown.
